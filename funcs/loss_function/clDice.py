...
class IBP_clDice(nn.Module):
    def __init__(self, alpha=0.5, smooth = 1., exclude_background=False):
        super(IBP_clDice, self).__init__()
        self.alpha = alpha
        self.smooth = smooth
        self.exclude_background = exclude_background
        self.ibp = Skeletonize_IBP()
    ...
    def forward(self, y_true, y_pred):
        ...
        skel_pred = self.ibp(y_pred)
        skel_true = self.ibp(y_true)
